...
const ScrapeNepali = () => {
  ...
  const nextNews = async () => {
    await axios
      .post("http://localhost:5000/api/fetchScrapeNepali", { dest: "Next News", changeCategory: "" })
      .then((response) =>
        setScraped({
          title: response.data.title,
          link: response.data.link,
  ...
  const prevNews = async () => {
    await axios
      .post("http://localhost:5000/api/fetchScrapeNepali", { dest: "Previous News", changeCategory: "" })
      .then((response) =>
        setScraped({
          title: response.data.title,
          link: response.data.link,
